 ...
 *          In the GlobalErrorHandler class, we are using this
 *          CustomErrorResponse class as a return type that will be
...
public class CustomErrorResponseTest {
	...
	/**
	 * to test the no parameter constructor of CustomErrorResponse
	 */
	@Mock
	Environment env;
	@Test
	...
	/**
	 * to test the all parameter constructor of CustomErrorResponse
	 */
