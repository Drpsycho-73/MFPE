...
/**
 * 
 * This class is used for all the end points of returning benchmark of acceptable no of NO's for a particular
 * audit type to  Audit Severity microservice. 

 *  AuthClient is used to verify the token.
 *  tokenService is to check token with authorized microservice
 *  env is to access values from properties file
...
public class BenchmarkController {
	...
	/**
	 * 
	 * @param token - used to verify the token with authorization service
